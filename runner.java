...
public class runner {
	...
	public static void main(String[] args) {
		...
		insturments.add(new Insturment("Solo ","Acoustic Guitar (nylon)","\""+staff+"\"",false,false));

		ArrayList<Note> oneTemp = MovementOne.generate(lowestNote,highestNote,lowEndOctave);
		...
		buildParts(timeStamp,"Reflections", finalPart,insturments);
